...
const ResetPassword = () => {
  ...
  const { passInfo } = useSelector((state) => state.resetPassword);
  console.log("password info", passInfo);
  ...
  const handleResetPassword = (data) => {
    ...
    console.log(id, token, passwordData);
    dispatch(resetPassword(id, token, passwordData, navigate));
  };
          ...
          >
            <div className="login-field">
              ...
              <input
                ...
                name="newPassword"
                {...register("newPassword", loginConfig.newPassword)}
              />
              {togglePassword ? (
                <svg
            ...
            <div className="login-field">
              ...
              <input
                ...
                {...register("confirmPassword", loginConfig.confirmPassword)}
              />
              {togglePassword ? (
                <svg
                  onClick={handlePasswordToggler}
